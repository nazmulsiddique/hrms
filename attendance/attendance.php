            ...
            <table class="table table-bordered table-striped align-middle text-center">
               ...
               <tbody>
                  <?php
                     ...
                     $shift_stmt->bind_param("s", $row['employee_id']);
                     $shift_stmt->execute();
                     ...
                     */
                     ...
                     ==================================================
                     */
                     $in_time  = !empty($row['in_time']) ? strtotime($row['in_time']) : null;
                     $out_time = !empty($row['out_time']) ? strtotime($row['out_time']) : null;
                     ...
                     */
                     ...
                     $shift_start = strtotime($row['attendance_date'] . ' ' . $shift['start_time']);
                     $shift_end   = strtotime($row['attendance_date'] . ' ' . $shift['end_time']);
                     
                     // Optional settings
                     $late_after  = !empty($shift['late_after'])
                     ? strtotime($row['attendance_date'] . ' ' . $shift['late_after'])
                     : $shift_start;
                     
                     $early_leave = !empty($shift['early_leave_before'])
                     ? strtotime($row['attendance_date'] . ' ' . $shift['early_leave_before'])
                     : $shift_end;
                     ...
                     4. OUT before early_leave_before = Early Gone
                     5. Otherwise = Present
                     ==============================================
                     */
